...
string_view QuerySystem::SystemName() {
    return this->osInfo.sysname; // example
}

string QuerySystem::OS_Name() {
    string_view sysName = this->SystemName();
...
string_view QuerySystem::GPUName() {
