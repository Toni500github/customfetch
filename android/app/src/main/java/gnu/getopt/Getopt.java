              ...
              if (argv[optind].startsWith("--"))
                {
                  ...
                  System.err.println(MessageFormat.format("{0}: unrecognized option '--{1}'",
                                   msgArgs));
                }
              else
                {
                  Object[] msgArgs = { progname, new
                                 ...
                                 nextchar };
                  System.err.println(MessageFormat.format("{0}: unrecognized option '{1}{2}'",
                                 msgArgs));
                }
            }
          ...
          if (posixly_correct)
            {
              ...
              Object[] msgArgs = { progname, new
                ...
                System.err.println(MessageFormat.format("{0}: illegal option -- {1}",
                        msgArgs));
            }
          else
            {
              Object[] msgArgs = { progname, new
                                   Character((char)c).toString() };
                System.err.println(MessageFormat.format("{0}: invalid option -- {1}",
                        msgArgs));
            }
        }
