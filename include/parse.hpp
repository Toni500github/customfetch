...
std::string parse(const std::string& input, systemInfo_t& systemInfo, std::string &pureOutput, Config& config, colors_t& colors, bool parsingLayout);
std::string parse(const std::string& input, systemInfo_t& systemInfo, Config& config, colors_t& colors, bool parsingLayout);
